...
const ModalDrop = (props) => {
    const { toggleModal, isModalVisible,onPress } = props;
    return (
        <View style={{ flex: 1 }}>
            <Modal isVisible={isModalVisible}>
                <View style={styles.Container}>
                    ...
                    <View style={{height:105,justifyContent:"center"}}>
                        <Text style={{textAlign:"center", fontFamily:R.fonts.bold, fontSize:14}}>Vui lòng đăng nhập để trải nghiệm chức năng này!</Text>
                    </View>
