...
import { SCREEN_ROUTER_APP, SCREEN_ROUTER_APP_ADD } from '../../../utils/Constant';
...
const InforUserAddScreen = ({route, navigation }) => {
      ...
      <SafeAreaView style={styles.Container}>
        <ScreenComponent
          ...
          rightComponent={ChangeUser(()=>{
            NavigationUtil.navigate(SCREEN_ROUTER_APP_ADD.UPDATEUSERADD,{data:user})
          })}
...
export default InforUserAddScreen
